...
'''raw = (mne.io.read_raw_egi('diksha_plr_nov2022/plr_test_20221108_025949.mff')
             .load_data()
             .filter(1,40)
             .copy()
             .resample(500)
             .crop(tmin=42.932, tmax=52.932)
        )'''

raw_et = mne.io.eyetracking.read_raw_eyelink('./test_eyelink.asc')
                #.copy()
